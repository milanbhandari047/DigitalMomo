    ...
    <>
      <div className="py-20 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        <div className="flex justify-start item-start space-y-5 flex-col">
          <h1 className="text-1xl dark:text-gray lg:text-2xl font-semibold leading-7 lg:leading-9 text-gray-800">
            Order {id}
          </h1>
              ...
              <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                ...
                <div className="flex w-full justify-center items-center md:justify-start md:items-start">
                  {filterOrder?.orderStatus !== "cancelled" && (
                    <>
                      <button
                        className="mt- md:mt-0 dark:border-white dark:hover:bg-gray-900 dark:bg-transparent dark:text-white py-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-gray-800 font-medium w-96 2xl:w-full text-base font-medium leading-4 text-gray-800"
